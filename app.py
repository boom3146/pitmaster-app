...
with col_control:
    ...
    with st.expander("🍯 ספריית מרינדות ותבלינים (כשר 💯)"):
        ...
        * **ברביקיו קוריאני: 2 כפות רוטב ברביקיו, 1 כף רוטב סויה, 1 כף סוכר חום, 1 כף שמן שומשום, 1 כפית שום כתוש, 1 כפית ג'ינגר טרי מגורד.
          * ⏳ **זמן מריחה:** 2-4 שעות לפני הצלייה.
        * **צ'ימיצ'ורי: 2 כפות שמן זית, 1 כף פטרוזיליה קצוצה, 1 כפית אורגנו, 1 כפית שום כתוש, 1 כף חומץ יין אדום, קמצוץ מלח.
          * ⏳ **זמן מריחה:** שעה לפני הצלייה.
        * **שום פלפל גרוס: 1 כף שמן זית, 1 כף פלפל שחור גרוס, 1 כפית אבקת שום, 1 כפית אבקת בצל, קמצוץ מלח.
          * ⏳ **זמן מריחה:** שעה לפני הצלייה.
        * **צ'ילי קפה: 1 כף שמן זית, 1 כפית אבקת אספרסו, 1 כפית צ'ילי גרוס, 1 כפית סוכר חום, פלפל שחור.
          * ⏳ **זמן מריחה:** שעה לפני הצלייה.
        ...
        * **ברביקיו: 2 כפות רוטב ברביקיו, 1 כף שמן זית, 1 כפית פפריקה מעושנת, 1 כפית אבקת שום, פלפל שחור.
          * ⏳ **זמן השריה:** 2-8 שעות.
        * **איטלקי: 2 כפות שמן זית, 1 כפית תיבול איטלקי, 1 כפית מיץ לימון, 1 כפית אבקת שום, פלפל שחור.
          * ⏳ **זמן השריה:** 30 דקות - 2 שעות.
        * **ראנצ': 2 כפות רוטב ראנצ', 1 כף אבקת בצל, 1 כפית שמיר מיובש, 1 כפית אבקת שום, פלפל שחור.
          * ⏳ **זמן השריה:** 30 דקות - 2 שעות.

        ### 🍣 דג (סלמון)
        * **ג'ינגר שום: 2 כפות רוטב סויה, 1 כף שמן זית, 1 כף סוכר חום, 1 כף ג'ינגר מגורר, 1 כף שום כתוש, 1 כף שומשום.
          * ⏳ **זמן השריה:** 30-60 דקות.
        * **טריאקי תפוז: 2 כפות רוטב טריאקי, 1 כף שמן זית, 1 כף סוכר חום, 1 כפית ג'ינגר מגורר, 1 שן שום כתושה, 1 כף מיץ תפוזים.
          * ⏳ **זמן השריה:** 30-60 דקות.
        * **שמיר פלפל לימון: 2 כפות שמן זית, 1 כף מיץ לימון, 1 כפית שמיר מיובש, 1 כפית פלפל שחור גרוס, 1 כפית מלח, 1 פלפל שחור.
          * ⏳ **זמן השריה:** 20-30 דקות.
        * **דיז'ון מייפל: 2 כפות חרדל דיז'ון, 1 כף מייפל, 1 כף שמן זית, 1 כפית פלפל שחור גרוס, 1 כפית שום כתוש, 1 כפית מלח.
          * ⏳ **זמן השריה:** 30 דקות.
